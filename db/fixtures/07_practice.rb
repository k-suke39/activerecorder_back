...
Practice.seed(:id,
              ...
              { id: 42, work_id: 3, chapter_id: 42, user_id: 5, title: 'current_userがコメントした投稿の中で最も多くいいねされた投稿を取得する',
                question: 'Bobがcurrent_userです。Bobがいいねした全ての投稿の中で最も多くコメントされたものを取得するためには、どのようにコードを書くべきでしょうか？', answer: 'current_user.comments.map(&:post).max_by { |post| post.likes.count }', order_number: 3 })
