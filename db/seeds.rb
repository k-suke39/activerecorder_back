...
practices = [
  ...
  { id: 2, work_id: 1, chapter_id: 2, user_id: 1, title: 'allメソッドを使ってみよう!',
    question: 'ユーザの一覧を取得してみましょう。', answer: 'User.all', order_number: 2 },
  { id: 3, work_id: 1, chapter_id: 3, user_id: 1, title: 'find_byメソッドを使ってみよう!',
    question: 'ユーザのidが8のレコードを取得してみましょう。', answer: 'User.find_by(id: 8)', order_number: 3 },
  { id: 4, work_id: 1, chapter_id: 4, user_id: 1, title: '他のデータも取得してみよう！',
    question: '投稿の一覧を取得してみましょう。', answer: 'Post.all', order_number: 4 },
  { id: 5, work_id: 1, chapter_id: 5, user_id: 1, title: 'whereメソッドを使ってみよう!',
  ...
  { id: 25, work_id: 2, chapter_id: 25, user_id: 5, title: 'current_userがいいねした投稿を取得する',
    question: 'Andersonがcurrent_userです。Andersonがいいねした投稿をすべて取得してください', answer: 'current_user.liked_posts', order_number: 3 },
  ...
  { id: 41, work_id: 3, chapter_id: 41, user_id: 10,
    title: 'current_userがいいねした全ての投稿の中で最も多くコメントされたものを取得する', question: 'Billがcurrent_userです。Billがコメントした投稿の中で最も多くいいねされたものを取得するためには、どのようにコードを書くべきでしょうか？', answer: 'current_user.likes.map(&:post).max_by { |post| post.comments.count }', order_number: 3 },
  { id: 42, work_id: 3, chapter_id: 42, user_id: 5, title: 'current_userがコメントした投稿の中で最も多くいいねされた投稿を取得する',
    question: 'Andersonがcurrent_userです。Andersonがいいねした全ての投稿の中で最も多くコメントされたものを取得するためには、どのようにコードを書くべきでしょうか？', answer: 'current_user.comments.map(&:post).max_by { |post| post.likes.count }', order_number: 3 }
]
